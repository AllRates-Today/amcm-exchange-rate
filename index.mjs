// Monetary Authority of Macao exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/amcm';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MOP', { apiKey }). */
